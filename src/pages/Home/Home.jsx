...
const Home = () => {
  ...
  return (
    <div
      className="bg-gray-900 text-white min-h-screen w-screen pb-16"
      style={{ width: "100vw",padding:"0", margin:"0" }}
    >
      <Navbar />
      <Carousel />

      <div className="w-full" style={{width:"90%",margin:"auto",marginTop:"20px"}}>
        {loading ? ( // Show loading spinner only on initial fetch
